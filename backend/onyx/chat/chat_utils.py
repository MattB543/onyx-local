...
def load_chat_file(
    ...
    # Fork: raw chat uploads have no backing UserFile row, so upstream's
    # early user_file lookup leaves token_count at 0. Fall back to the
    # chat-upload token store, then to an estimate from the extracted text.

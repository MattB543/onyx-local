      ...
      <SettingsLayouts.Root>
        ...
        <SettingsLayouts.Body>
          ...
          <SimpleCollapsible defaultOpen={false}>
            <SimpleCollapsible.Header
              title="CRM Settings"
              description="Configure contact stages and category suggestions for the built-in CRM."
            />
            <SimpleCollapsible.Content>
              <Section gap={1}>
                ...
                <InputVertical
                  title="Contact Stage Options"
                  subDescription="One stage per line. The first stage is used as the default for new contacts."
                  withLabel
                >
                  <InputTextArea
                    value={crmStageOptionsRaw}
                    onChange={(e) => setCrmStageOptionsRaw(e.target.value)}
                    placeholder={"lead\nactive\ninactive\narchived"}
                    rows={5}
                  />
                </InputVertical>
                <InputVertical
                  title="Contact Category Suggestions"
                  subDescription="One category per line. Users can still enter custom categories."
                  withLabel
                >
                  <InputTextArea

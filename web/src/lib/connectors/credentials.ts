...
// Gmail, Google Drive and Google Calendar use dedicated credential UIs, so their templates are partial.
type CredentialTemplateMap = Record<ValidSources, object | null> & {
  ...
  google_calendar: Partial<GoogleCalendarCredentialJson>;

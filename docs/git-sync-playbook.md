...
| ------------------ | --------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| CRM module         | `backend/onyx/db/crm.py`, `backend/onyx/tools/tool_implementations/crm/`, `backend/onyx/server/features/crm/`, `web/src/refresh-pages/crm/`, `web/src/refresh-pages/Crm*.tsx`, `web/src/app/app/crm/`, `web/src/lib/hooks/useCrm*.ts`, `web/src/app/app/message/messageComponents/timeline/renderers/crm/CrmToolRenderer.tsx` | `pytest backend/tests/unit/onyx/db/test_crm_queries.py backend/tests/unit/tools/test_crm_tool_packets.py backend/tests/unit/tools/test_crm_list_tool.py backend/tests/unit/onyx/server/features/test_crm_api.py` |
...
| Email-to-CRM pipeline + Email Queue tab | `backend/onyx/custom_jobs/workflows/email_crm_processor.py`, `backend/onyx/custom_jobs/steps/process_email_crm.py`, `backend/onyx/server/features/crm/email_queue_api.py`, `web/src/refresh-pages/CrmEmailQueuePage.tsx`, `web/src/lib/hooks/useCrmEmailQueue.ts`, `web/src/app/app/crm/emailQueueService.ts` | `pytest backend/tests/unit/onyx/custom_jobs/test_email_crm_workflow.py backend/tests/unit/onyx/custom_jobs/test_email_crm_steps.py` |
...
| CRM policy fields + category taxonomy | `backend/onyx/db/crm.py`, `backend/onyx/db/models.py`, `backend/onyx/prompts/tool_prompts.py`, `backend/onyx/server/features/crm/models.py`, `backend/onyx/server/features/crm/csv_utils.py`, `web/src/refresh-pages/crm/crmOptions.ts`, migration `d4061bb581a7` | `pytest backend/tests/unit/onyx/db/test_crm_queries.py backend/tests/unit/onyx/server/features/test_crm_api.py backend/tests/unit/tools/test_crm_list_tool.py` (asserts `party_affiliation`/`us_state`/`principal`) |
...
| CRM frontend unit tests | `web/src/lib/crmService.test.ts`, `web/src/components/ContactAvatar.test.tsx`, `web/src/refresh-pages/crm/crmOptions.test.ts`, `web/src/refresh-pages/crm/components/crmDateUtils.test.ts`, `web/src/refresh-pages/crm/components/CrmDateRangeFilter.test.ts` | `cd web && npx jest src/lib/crmService.test.ts src/components/ContactAvatar.test.tsx src/refresh-pages/crm` |
...
Note: `web/src/refresh-pages/` and `web/src/refresh-components/` paths above will move when upstream's `views/` rename (c86993bcd2) merges — update this table after that batch.
